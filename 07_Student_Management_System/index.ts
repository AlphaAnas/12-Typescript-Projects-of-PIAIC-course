      ...
      switch (input.option) {
          ...
          if (st_index === -1) {
            ...
            if (option.option === "Unenroll") {
              ...
              const enrolled_formatted_student = {
                ...
                courses: this.students[st_index].courses.map(
                  (course) => `${course.name} ($${course.fee})`
                ),
              };
        ...
        case "View Pending Balance":
          ...
          if (index === -1) {
            ...
            const pending_amount = this.students[index].courses.reduce(
        ...
        case "Pay Tution Fees":
          ...
          if (id === -1) {
            ...
            if (this.students[id].balance === 0) {
              console.log(
                chalk.greenBright(
                  "Please recharge your account to pay fees, free version expired"
                )
              );
              break;
            } else {
