...
const main = async (total, randomNumber) => {
    let attempts = 0;
    while (true) {
        ...
        if (answers.userGuessedNumber == randomNumber) {
            ...
            console.error(chalk.yellow("Invalid data type. Please enter a number between 1 and 10"));
            continue;
        }
        else {
            ...
            attempts += 1;
            if (total - attempts == 1) {
                console.log(chalk.green(`The number is between ${randomNumber - 3} and ${randomNumber + 2}`));
            }
        }
    }
};
